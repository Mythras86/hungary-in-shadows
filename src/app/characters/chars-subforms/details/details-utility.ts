export const detailsUtil: Array<any> = [
  {meret: "50", fejlec: 'Teljes név', fcName:'teljesnev', tipus: 'text', megjegyzes: 'Amit a sírodra vésnek, ha kisimultak az intenzív vonalaid...'},
  {meret: "50", fejlec: 'DNS', fcName:'dns', tipus: 'select', megjegyzes:'Nem faj! Legfeljebb fajta te rasszista állat!'},
  {meret: "50", fejlec: 'Becenév', fcName:'becenev', tipus: 'text', megjegyzes: 'Ahogy a haverok ismernek, már ha még élnek...'},
  {meret: "50", fejlec: 'Nem', fcName:'nem', tipus: 'inpselect', megjegyzes:'Nem? De! Vagy mit tudom én!?'},
  {meret: "50", fejlec: 'Álnév', fcName:'alnev', tipus: 'text', megjegyzes: 'Az alvilágban jobb, ha csak ezt ismerik...'},
  {meret: "50", fejlec: 'Anyanyelv', fcName:'anyanyelv', tipus: 'inpselect', megjegyzes:'Kezdj el csicseregni, de ha kitolod, levágjuk...'},
  {meret: "50", fejlec: 'Életkor', fcName:'eletkor', tipus: 'number', megjegyzes: 'Ezért a vénségért mennyit kapni a rabszolgapiacon?', egyseg: ' év', lepes: 10},
  {meret: "50", fejlec: 'Testsúly', fcName:'testsuly', tipus: 'number', megjegyzes: 'Szerinted lecsontozva mennyit ér a húsod?', egyseg: ' kg', lepes: 10},
  {meret: "50", fejlec: 'Magasság', fcName:'magassag', tipus: 'number', megjegyzes: 'Ettől függ, hogy hokedlinek, vagy toronynak becéznek.', egyseg: ' cm', lepes: 10},
  {meret: "50", fejlec: 'Testalkat', fcName:'testalkat', tipus: 'text', megjegyzes: 'Ki a mellet, be a hasat, hadd mártom meg benned a vasat!'},
  {meret: "50", fejlec: 'Kedv. szín', fcName:'kedvencszin', tipus: 'color', megjegyzes: 'Mi a kedvenc színed? Barna? Nem, a kékááá...'},
  {meret: "50", fejlec: 'Hajstílus', fcName:'hajstilus', tipus: 'text', megjegyzes: 'Az Árnyak között is fontos a jó megjelenés!'},
  {meret: "50", fejlec: 'Hajszín', fcName:'hajszin', tipus: 'color', megjegyzes: 'Milyet szeretnél? Van egyáltalán saját hajad?'},
  {meret: "50", fejlec: 'Bőrszín', fcName:'borszin', tipus: 'color', megjegyzes: 'Hidd el, lassan már senkit nem érdekel, kivéve ha ember vagy.'},
  {meret: "50", fejlec: 'Szemszín', fcName:'szemszin', tipus: 'color', megjegyzes: 'Kék a szeme, arca csupa derű...'},
  {meret: "50", fejlec: 'Szőrzet', fcName:'szorszin', tipus: 'color', megjegyzes: 'A hajat szokták festeni, de milyen színű a fa... famentes papír?'},
